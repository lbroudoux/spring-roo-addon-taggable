...
@Service
public class TaggableCommands implements CommandMarker { // All command types must implement the CommandMarker interface
	
	/**
	 * Get a reference to the TaggableOperations from the underlying OSGi container
	 */
	@Reference private TaggableOperations operations;
	 ...
	 */
	@CliAvailabilityIndicator({ "taggable setup", "taggable add", "taggable all" })
	 ...
	 * @param type 
	 */
	@CliCommand(value = "taggable add", help = "Some helpful description")
	 ...
	 * 
	 */
	@CliCommand(value = "taggable all", help = "Some helpful description")
	public void all() {
	 ...
	 * 
	 */
	@CliCommand(value = "taggable setup", help = "Setup Taggable addon")
	public void setup() {
		operations.setup();
	}
}